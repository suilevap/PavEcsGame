...
namespace PavEcsGame.GameLoop
{
    ...
    class MapData<T> : IMapData<Int2, T>, IMapData<PositionComponent, T>
    {
        ...
        public ref T Get(in Int2 pos) => ref _data[pos.X, pos.Y];
        ...
        PositionComponent IMapData<PositionComponent, T>.MinPos => new PositionComponent(MinPos);

        PositionComponent IMapData<PositionComponent, T>.MaxPos => new PositionComponent(MaxPos);


        public ref T Get(in PositionComponent pos) => ref Get(in pos.Value);
